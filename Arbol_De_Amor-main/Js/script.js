...
function showDedicationText() { //seguidores
  ...
  if (!text) {
    text = `Para mi amorcito precioso mi Marecita:\n\nDesde el primer momento supe que eras tú. Tu sonrisa, tu voz, tu forma de ser… todo en ti me hace sentir en casa.No he conocido lugar más seguro que tus brazos, no he conocido otra persoan que me llene de paz como lo haces tú,sencillo no hay nadie mejor que tú para mí,no existe persona que te supere tanto en sueños, metas e ideales,cada dia que paso a tu lado me convenzo más y más que elegirnos fue lo correcto\n\nGracias por acompañarme en cada paso, por entenderme incluso en silencio, y por llenar mis días de amor.\n\nTe amo más de lo que las palabras pueden expresar.`;  } else {
...
function showSignature() {
  ...
  signature.textContent = firma ? decodeURIComponent(firma) : "Con amor, Michael";
...
function showCountdown() {
  ...
  let startDate = startParam ? new Date(startParam + 'T00:00:00') : new Date('2024-12-18T00:00:00'); 
  let eventDate = eventParam ? new Date(eventParam + 'T00:00:00') : new Date('2025-06-18T00:00:00');
  ...
  function update() {
    ...
    container.innerHTML =
      ...
      `Nuestros primeros 6 meses: <b>${eventDays}d ${eventHours}h ${eventMinutes}m ${eventSeconds}s</b>`;
